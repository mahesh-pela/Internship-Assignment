...
for i in range(0, len(lineContours)):
    ...
    if not np.isfinite(pd1) or not np.isfinite(pd2):
        continue  # Skip this iteration if perpendicular distance is not finite
...
cv2.imwrite('result_image.png', rotatedImgContour)
print("Success!!!")
